package com.boot.bucket.common.extend.shiro;
...
public abstract class ExtendAuthenticatingRealm extends CachingRealm implements Initializable {
    ...
    /**
     * 代替 {@link org.apache.shiro.realm.AuthenticatingRealm#init()}
     */
    @Override
    public void init() {
    ...
    /**
     * 代替 {@link org.apache.shiro.realm.AuthenticatingRealm#getAuthenticationInfo(AuthenticationToken)}
     *
     * @param token
     * @return
